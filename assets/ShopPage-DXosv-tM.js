...
`,Hn="/e-pharmacy-franchise/assets/Pills-CPKWkFla.png",zn=({title:t,inputs:e,titleButton:r,register:i,handleSubmit:n,onSubmit:o,errors:s,setModal:c,photo:a})=>{var g;const[l,u]=b.useState(null),d=h=>{const x=h.target.files[0];if(x){const m=new FileReader;m.onload=f=>{u(f.target.result)},m.readAsDataURL(x)}};return p.jsxs(p.Fragment,{children:[p.jsx(Fn,{children:t}),p.jsx(jn,{$img:l||a,children:l?p.jsx(gt,{src:l}):a?p.jsx(gt,{src:a}):p.jsx(ki,{src:Hn,alt:"Pill",loading:"lazy"})}),p.jsxs(Ei,{onSubmit:n(o),children:[p.jsxs(Vi,{children:[e.map((h,x)=>{var m;return p.jsxs(Jt,{children:[h.type==="file"?p.jsxs(p.Fragment,{children:[p.jsxs(Li,{children:[p.jsx(Rn,{}),p.jsxs(Ti,{children:[" ",l?"Image is chosen":"Upload image"]})]}),p.jsx(en,{type:h.type,...i(h.name),onChange:d})]}):p.jsxs(p.Fragment,{children:[p.jsx(Qt,{children:h.label}),p.jsx(en,{placeholder:"Enter text",type:h.type,...i(h.name)})]}),p.jsx(tn,{children:(m=s[i(h.name).name])==null?void 0:m.message})]},x)}),p.jsxs(Jt,{children:[p.jsx(Qt,{children:"Description"}),p.jsx(Di,{...i("description"),rows:"4",placeholder:"Enter text"}),p.jsx(tn,{children:(g=s.description)==null?void 0:g.message})]})]}),p.jsxs(An,{children:[p.jsx($n,{name:"submit",type:"submit","aria-label":r,children:r}),p.jsx(_n,{name:"cancel",type:"reset","aria-label":"Cancel",onClick:()=>c(!1),children:"Cancel"})]})]})]})},Mt=S.div`
  position: fixed;
  top: 0;
  left: 0;
  width: 100%;
...
`;function Ri(t,e){const r=t==null?void 0:t.split(" ");let i="",n="";if(!t||e>=t.length)i=t;else{for(let o=0;o<r.length;o+=1)i.length<=e-2&&(i+=r[o]+" ",i.length>e-2&&(n=i.slice(0,-(r[o].length+2))+"..."));i=n}return i}const Fi=({setModal:t,productId:e,photo:r,price:i,name:n,description:o})=>{const s=Pe(),{shopId:c}=_e(Pt),a=[{label:"Upload image",name:"photo",type:"file"},{label:"Medicine Name",name:"name",type:"text"},{label:"Price",name:"price",type:"text"}],l=Ri(o,165),{register:u,handleSubmit:d,formState:{errors:g}}=Dn({mode:"onChange",defaultValues:{name:n,price:i,description:l}});function h(f){const v=new FormData;for(const y in f)y==="photo"&&f[y][0]?v.append(y,f[y][0]):f[y]&&v.append(y,f[y]);s(Ar({id:c,productId:e,formData:v})).unwrap().then(()=>{F.success("Congratulations! The medicine is updated successfully!"),t(!1),s(Ie({id:c})).unwrap().then(()=>{F.success("The products of your shop are received")}).catch(y=>F.error(y))}).catch(y=>F.error(y))}function x(f){f.target===f.currentTarget&&t(!1)}document.addEventListener("keydown",m);function m(f){f.code==="Escape"&&(t(!1),document.removeEventListener("keydown",m))}return p.jsx(Mt,{onClick:x,children:p.jsxs(Nn,{children:[p.jsx(kt,{onClick:()=>t(!1),children:p.jsx(It,{})}),p.jsx(zn,{title:"Edit medicine",inputs:a,titleButton:"Save medicine",register:u,handleSubmit:d,onSubmit:h,errors:g,setModal:t,photo:r})]})})},ji=S.p`
  font-size: 14px;
  line-height: 1.28571;
  color: #6a6a6f;
  margin-top: 8px;
...
`,_i=({title:t,titleButton:e,setModal:r,photo:i,shopId:n,productId:o,suppliers:s,name:c})=>{const a=Pe();function l({shopId:u,productId:d}){a($r({id:u,productId:d})).unwrap().then(()=>{F.success("The product has been deleted from your shop successfully!"),a(Ie({id:u})).unwrap().then(()=>{F.success("The products of your shop are received")}).catch(g=>F.error(g))}).catch(g=>F.error(g))}return p.jsxs(p.Fragment,{children:[p.jsx(Fn,{children:t}),p.jsx(ji,{children:"Are you sure you want to delete this item?"}),p.jsx(jn,{$img:i,children:i?p.jsx(gt,{src:i}):p.jsx("img",{src:Hn,alt:"Pill",loading:"lazy"})}),p.jsx(Ai,{children:c}),p.jsx($i,{children:s}),p.jsxs(An,{children:[p.jsx($n,{name:"confirm",type:"submit","aria-label":e,onClick:()=>l({shopId:n,productId:o}),children:e}),p.jsx(_n,{name:"cancel",type:"reset","aria-label":"Cancel",onClick:()=>r(!1),children:"Cancel"})]})]})},Hi=S.div`
  width: 88.06%;
  position: relative;
  border: 1px solid rgba(104, 104, 104, 0.2);
